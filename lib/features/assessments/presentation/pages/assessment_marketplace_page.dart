...
class AssessmentMarketplacePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (kDebugMode) {
      ...
      final count = assessmentsAsync.asData?.value.length ?? 0;
      print('--- DEBUG BUILD: Assessment Marketplace Page ---');
      print('Route: $currentRoute');
      print('Loaded Assessments Count: $count');
      print('------------------------------------------------');
    }
                      ...
                      return Wrap(
                        ...
                        children: assessments.map((assessment) {
                          ...
                          if (kDebugMode) {
                            ...
                            print('DEBUG MARKETPLACE CARD: User ID: ${user?.id}, Access Count: ${accesses.length}, Assessment ID: ${assessment.id}, Computed UI State: ${access != null ? access.status : (isInCart ? 'in_cart' : 'add_to_cart')}');
                          }
                          ...
                          return SizedBox(
                            width: itemWidth,
                            height: 240, // Bounded card height to prevent RenderBox constraint crashes
                            child: AppCard(
                              padding: const EdgeInsets.all(AppSpacing.md),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
